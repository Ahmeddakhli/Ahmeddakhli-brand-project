...
[Get Postman Collection](http://localhost:8088/brand-main/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"blanditiis","ip_address":"quia","latitude":"molestiae","longitude":"rerum"}'
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"soluta","latitude":"amet","longitude":"voluptas"}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/holidays?location_id=delectus&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=et&follow_up_type=aut&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=voluptatum&biz_name=quisquam&mobile_num=1&contact_id=recusandae&order_by=quibusdam&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"sint","mobile_name":"reprehenderit","call_type":"call","start_time":"est","end_time":"est","duration":"fuga"}]}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=aut&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":13,"initial_amount":938815,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":28816226.65,"total_card_slips":16,"total_cheques":17,"closing_note":"in","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/contactapi?type=distinctio&name=neque&biz_name=fugiat&mobile_num=16&contact_id=aspernatur&order_by=omnis&direction=ipsa&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"illo","prefix":"quae","first_name":"voluptatem","middle_name":"possimus","last_name":"dolor","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"est","address_line_2":"fuga","city":"id","state":"tempore","country":"consequuntur","zip_code":"molestiae","customer_group_id":"architecto","contact_id":"earum","dob":"2000-06-13","custom_field1":"et","custom_field2":"culpa","custom_field3":"qui","custom_field4":"eos","email":"sunt","shipping_address":"fugiat","position":"commodi","opening_balance":0,"source_id":18,"life_stage_id":12,"assigned_to":[]}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"earum","prefix":"est","first_name":"quidem","middle_name":"assumenda","last_name":"eum","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"assumenda","address_line_2":"magnam","city":"eveniet","state":"incidunt","country":"nobis","zip_code":"dicta","customer_group_id":"amet","contact_id":"voluptatum","dob":"2000-06-13","custom_field1":"ea","custom_field2":"rerum","custom_field3":"nihil","custom_field4":"est","email":"nemo","shipping_address":"et","position":"accusamus","opening_balance":10.3,"source_id":7,"life_stage_id":20,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_2": "magnam",
    "city": "eveniet",
    "state": "incidunt",
    "country": "nobis",
    "zip_code": "dicta",
    "customer_group_id": "amet",
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":20,"card_number":"omnis","card_holder_name":"voluptate","card_transaction_number":"inventore","card_type":"molestiae","card_month":"ut","card_year":"laudantium","card_security":"amet","transaction_no_1":"dolores","transaction_no_2":"debitis","transaction_no_3":"consectetur","cheque_number":"excepturi","bank_account_number":"quaerat","note":"nihil"}'
...
let body = {
    ...
    "account_id": 20,
    "card_number": "omnis",
    "card_holder_name": "voluptate",
    "card_transaction_number": "inventore",
    "card_type": "molestiae",
    "card_month": "ut",
    "card_year": "laudantium",
    "card_security": "amet",
    "transaction_no_1": "dolores",
    "transaction_no_2": "debitis",
    "transaction_no_3": "consectetur",
    "cheque_number": "excepturi",
    "bank_account_number": "quaerat",
    "note": "nihil"
}
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/expense?location_id=error&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=rem&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":20,"final_total":60890.669,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":3,"expense_for":1,"contact_id":15,"additional_notes":"hic","is_refund":0,"is_recurring":0,"recur_interval":15,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ex","recur_repetitions":5,"payment":[{"amount":453.13,"method":"cash","account_id":12,"card_number":"quis","card_holder_name":"ex","card_transaction_number":"fuga","card_type":"officiis","card_month":"atque","card_year":"asperiores","card_security":"dolor","transaction_no_1":"harum","transaction_no_2":"nam","transaction_no_3":"soluta","note":"esse","cheque_number":"voluptatibus"}]}'
...
let body = {
    "location_id": 20,
    "final_total": 60890.669,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 3,
    "expense_for": 1,
    "contact_id": 15,
    "additional_notes": "hic",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 15,
    ...
    "payment": [
        {
            ...
            "card_number": "quis",
            "card_holder_name": "ex",
            "card_transaction_number": "fuga",
            "card_type": "officiis",
            "card_month": "atque",
            "card_year": "asperiores",
            "card_security": "dolor",
            "transaction_no_1": "harum",
            "transaction_no_2": "nam",
            "transaction_no_3": "soluta",
            "note": "esse",
            "cheque_number": "voluptatibus"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost:8088/brand-main/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":20.23904,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":12,"expense_for":1,"contact_id":8,"additional_notes":"quae","is_recurring":0,"recur_interval":17,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"inventore","recur_repetitions":6,"payment":[]}'
...
let body = {
    "final_total": 20.23904,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 12,
    "expense_for": 1,
    "contact_id": 8,
    "additional_notes": "quae",
    "is_recurring": 0,
    "recur_interval": 17,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "inventore",
    "recur_repetitions": 6,
    "payment": []
}
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/expense-refund?location_id=exercitationem&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=sit&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/product?brand_id=exercitationem&category_id=consequuntur&sub_category_id=dolorum&location_id=voluptatem&selling_price_group=modi&name=odio&sku=aliquid&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/product"
);

let params = {
    "brand_id": "exercitationem",
    "category_id": "consequuntur",
    "sub_category_id": "dolorum",
    "location_id": "voluptatem",
    "selling_price_group": "modi",
    "name": "odio",
    "sku": "aliquid",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/product/1?selling_price_group=ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/variation/?brand_id=et&category_id=qui&sub_category_id=enim&not_for_selling=sit&name=autem&sku=iusto&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/sell?location_id=et&contact_id=et&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=voluptatem&service_staff_id=facere&shipping_status=ordered&only_subscriptions=quibusdam&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "voluptatem",
    "service_staff_id": "facere",
    "shipping_status": "ordered",
    "only_subscriptions": "quibusdam",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":3,"contact_id":19,"transaction_date":"2020-07-22 15:48:29","invoice_no":"velit","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"perferendis","staff_note":"eius","commission_agent":15,"shipping_details":"Express Delivery","shipping_address":"ut","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":6,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":15,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"officiis","recur_repetitions":1,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":20,"service_custom_field_1":"et","service_custom_field_2":"laboriosam","service_custom_field_3":"voluptatem","service_custom_field_4":"error","round_off_amount":1.3,"table_id":10,"service_staff_id":9,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":1,"note":"ut"}],"payments":[{"amount":453.13,"method":"cash","account_id":7,"card_number":"omnis","card_holder_name":"in","card_transaction_number":"architecto","card_type":"aut","card_month":"eos","card_year":"quaerat","card_security":"et","transaction_no_1":"repudiandae","transaction_no_2":"incidunt","transaction_no_3":"facere","bank_account_number":"ut","note":"dolorum","cheque_number":"et"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "officiis",
            "recur_repetitions": 1,
            "rp_redeemed": 15,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 20,
            "service_custom_field_1": "et",
            "service_custom_field_2": "laboriosam",
            "service_custom_field_3": "voluptatem",
            "service_custom_field_4": "error",
            "round_off_amount": 1.3,
            "table_id": 10,
            "service_staff_id": 9,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_number": "omnis",
                    "card_holder_name": "in",
                    "card_transaction_number": "architecto",
                    "card_type": "aut",
                    "card_month": "eos",
                    "card_year": "quaerat",
                    "card_security": "et",
                    "transaction_no_1": "repudiandae",
                    "transaction_no_2": "incidunt",
                    "transaction_no_3": "facere",
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://localhost:8088/brand-main/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":8,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":8,"discount_amount":10,"discount_type":"fixed","sale_note":"neque","staff_note":"consequatur","sells":[{"is_suspend":false}],"commission_agent":2,"shipping_details":"Express Delivery","shipping_address":"quas","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":14,"pay_term_type":"months","is_recurring":0,"recur_interval":18,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"enim","recur_repetitions":19,"rp_redeemed":13,"rp_redeemed_amount":13.5,"types_of_service_id":15,"service_custom_field_1":"tempore","service_custom_field_2":"inventore","service_custom_field_3":"corrupti","service_custom_field_4":"illo","round_off_amount":111582164.06137796,"table_id":17,"service_staff_id":8,"change_return":0,"change_return_id":10,"products":[{"sell_line_id":1,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":6,"discount_amount":0,"discount_type":"percentage","sub_unit_id":5,"note":"sit"}],"payments":[{"payment_id":10,"amount":453.13,"method":"cash","account_id":2,"card_number":"dolores","card_holder_name":"et","card_transaction_number":"quia","card_type":"aut","card_month":"at","card_year":"ut","card_security":"et","transaction_no_1":"autem","transaction_no_2":"voluptatem","transaction_no_3":"neque","note":"beatae","cheque_number":"voluptas","bank_account_number":"dolore"}]}'
...
let body = {
    ...
    "service_custom_field_1": "tempore",
    "service_custom_field_2": "inventore",
    "service_custom_field_3": "corrupti",
    "service_custom_field_4": "illo",
    "round_off_amount": 111582164.06137796,
    "table_id": 17,
    "service_staff_id": 8,
    "change_return": 0,
    "change_return_id": 10,
    ...
    "payments": [
        {
            ...
            "card_year": "ut",
            "card_security": "et",
            "transaction_no_1": "autem",
            "transaction_no_2": "voluptatem",
            "transaction_no_3": "neque",
            "note": "beatae",
            "cheque_number": "voluptas",
            "bank_account_number": "dolore"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost:8088/brand-main/public/connector/api/sell/illum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":12,"transaction_date":"2020-5-7 15:20:22","invoice_no":"harum","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":15,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":9,"shipping_status":"ordered","delivered_to":"accusamus"}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/table?location_id=quasi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/taxonomy?type=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/user?service_staff=recusandae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/user"
);

let params = {
    "service_staff": "recusandae",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost:8088/brand-main/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"sequi","new_password":"quas"}'
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/profit-loss-report?location_id=laborum&start_date=2018-06-25&end_date=2018-06-25&user_id=aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost:8088/brand-main/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost:8088/brand-main/public/connector/api/notifications"
);
