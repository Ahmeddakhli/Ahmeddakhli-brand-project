...
class TransactionUtil extends Util
{
     ...
     * @return boolean
     */
    public function createSellTransaction($pjt_project_id,$business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
    ...
    */
    ...
    public function createExpense($request, $business_id, $user_id, $format_data = true)
    {
        $transaction_data = $request->only([ 'ref_no', 'transaction_date', 
            ...
            'expense_category_id', 'tax_id', 'contact_id','pjt_project_id']);
