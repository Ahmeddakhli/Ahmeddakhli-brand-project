...
Route::group(['middleware' => ['web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu'], 'prefix' => 'project', 'namespace' => 'Modules\Project\Http\Controllers'], function () {
    ...
    Route::get('/viewPurchase/{projectid}', 'ProjectController@viewPurchase')->name('project.viewPurchase');

    Route::post('/viewPurchase/{projectid}/update', 'ProjectController@storePurchase')->name('project.storePurchase');

    Route::get('/viewSell/{sellid}', 'ProjectController@viewSell')->name('project.viewSell');

    Route::get('/viewExpense/{expenseid}', 'ProjectController@viewExpense')->name('project.viewExpense');
