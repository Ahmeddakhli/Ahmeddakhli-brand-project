...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::select('contact_id', ['sad'], null, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'supplier_id']); !!}
				...
				{{--supplier --}}
				{{--  <input type="text"  name="contact_id" value= 2>  --}}
				<input type="hidden" name="pjt_project_id" value={{$projectid}}>
			...
			<div style="display: none" class="col-sm-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif">
				<div class="form-group">
...
<div style="display: none">
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
		<div  class="box-body payment_row">
			<div class="row" style="display: none">
				<div class="col-md-12">
					<strong style="display: none">@lang('lang_v1.advance_balance'):</strong> <span id="advance_balance_text">0</span>
