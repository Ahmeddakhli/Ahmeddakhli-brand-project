...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	{!! Form::open(['url' => action('SellPosController@store'), 'method' => 'post', 'id' => 'add_sell_form', 'files' => true ]) !!}
	 ...
	 <input type="hidden" name="pjt_project_id" value={{$sellid}}>
		...
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				{{--  @if(in_array('subscription', $enabled_modules))
					<div class="col-md-4 pull-right col-sm-6">
						<div class="checkbox">
							...
							<button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="btn btn-link"><i class="fa fa-external-link"></i></button>@show_tooltip(__('lang_v1.recurring_invoice_help'))
						</div>
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif">
					...
					{{--  supplier  عميل --}}
					<input type="hidden" name="contact_id"  value={{$content_id }}>
